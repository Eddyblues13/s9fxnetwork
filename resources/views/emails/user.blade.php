                    ...
                    <tr>
                        <td class="email-masthead">
                            <a href="'.$site_url.'" class="">
                                <img src="{{asset('image/logo.png')}}" class="email-masthead_logo">
                            </a>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell" align="center">
                                        <p class="f-fallback sub align-center">&copy; https://s9fxnetwork.com/ All
                                            rights reserved.</p>
                                        <p class="f-fallback sub align-center">
                                            S9fx Network
                                            <br>https://s9fxnetwork.com/
                                        </p>
                                    </td>
                                </tr>
                            </table>
