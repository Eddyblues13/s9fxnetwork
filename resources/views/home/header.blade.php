...
<head>
    ...
    <title>S9fx Network Company</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description"
        content="S9fx Network Limited is a recognized leader in online Cryptocurrency trading and stock Market exchange with years of experience and a global presence. Our platform has everything you need to become an effective trader.">

    <!-- Open Graph tags for better social sharing -->
    <meta property="og:site_name" content="S9fx Network Limited" />
    <meta property="og:title" content="Welcome to S9fx Network and Investment Limited" />
            ...
            <div class="navbar-area">
                ...
                <div class="mobile-nav">
                    <a href="{{ url('/') }}" class="logo">
                        <img src="{{ asset('assets/img/logo1.png') }}" alt="Logo" style="height:45px;">
                    </a>
                </div>
