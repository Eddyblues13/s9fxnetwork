    ...
    <div class="content bg-dark">
        <div class="page-inner">
            <div class="mt-2 mb-4">
                ...
                <h5 id="ann" class="text-lightop-7 mb-4">Welcome to your S9fx Network dashboard, control and monitor
                    your
                    trading account</h5>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="p-3 card bg-dark shadow">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="mb-1 text-light"><b>${{number_format($total_balance, 2, '.', ',')}}</b></h5>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="p-3 card bg-dark shadow">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="mb-1 text-light"><b>${{number_format($profit_balance, 2, '.', ',')}}</b></h5>
                                <small class="text-muted text-light">Total Profit</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="p-3 card bg-dark shadow">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="mb-1 text-light"><b>${{number_format($earning_balance, 2, '.', ',')}}</b>
                                </h5>
                                <small class="text-muted text-light">Total Bonus</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="p-3 card bg-dark shadow">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="mb-1 text-light"><b>${{number_format($referral_balance, 2, '.', ',')}}</b>
                                </h5>
                                <small class="text-muted text-light">Total Referral Bonus</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-3 card bg-dark shadow">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <small class="text-muted text-light">Total Investment Plans</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="p-3 card bg-dark shadow">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="mb-1 text-light"><b>0</b></h5>
                                <small class="text-muted text-light">Total Active Investment Plans</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="p-3 card bg-dark shadow">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="mb-1 text-light">${{number_format($deposit_balance, 2, '.', ',')}}</h5>

                                <small class="text-muted text-light">Total Deposit</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="p-3 card bg-dark shadow">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="mb-1 text-light">${{number_format($withdrawal_balance, 2, '.', ',')}}</h5>

                                <small class="text-muted text-light">Total Withdrawals</small>
                            </div>
                        </div>
                    </div>
                </div>
