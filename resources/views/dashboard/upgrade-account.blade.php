                ...
                <div class="card bg-dark shadow" style="max-width: 600px; margin: 0 auto;">
                    <div class="card-body">
                        <div class="py-4">
                            ...
                            <p class="text-muted">Please make a payment to any of our wallet addresses below and contact
                                our administration team with your transaction details.</p>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="wallets-container">
                                    ...
                                    <div class="wallet-detail mb-3 p-3 bg-darker rounded">
                                        ...
                                        <p class="mb-1"><strong>Account Holder:</strong> {{ $wallet->account_holder }}
                                        </p>
                                        <p class="mb-1"><strong>Account Number:</strong> {{ $wallet->account_number }}
                                        </p>
                                        ...
                                        @else
                                        <h6 class="text-info">{{ strtoupper($wallet->type) }} ({{ $wallet->network }})
                                        </h6>
                                        <p class="mb-1"><strong>Address:</strong> <span class="text-warning">{{
