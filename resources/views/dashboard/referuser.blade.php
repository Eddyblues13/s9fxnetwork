...
<div class="main-panel bg-dark">
    <div class="content bg-dark">
        <div class="page-inner">
            <div class="mt-2 mb-4">
                <h1 class="title1 text-light">Refer users to S9fx Network community</h1>
            </div>
            <div>
            </div>
            <div>
            ...
            <div class="row">
                <div class="col-md-12 text-center card bg-dark shadow-lg p-3 text-light">
                    <div class="p-4 row">
                        <div class="col-md-8 offset-md-2">
                            <strong>You can refer users by sharing your referral link:</strong><br>
                            <div class="mb-3 input-group">
                                <input type="text" class="form-control myInput readonly text-light bg-dark"
                        ...
                        <div class="mt-4 col-md-12">
                            <h2 class="title1 text-light text-left">Your Referrals.</h2>
