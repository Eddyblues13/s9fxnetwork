                        ...
                        <div class="uk-grid uk-flex-center">
                            <div class="uk-width-3-5@m">
                                <div class="in-padding-horizontal@s">
                                    ...
                                    <p class="uk-text uk-margin-remove-top uk-margin-medium-bottom">Don't have an
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <!--   <div class="uk-margin-small uk-width-expand uk-text-small">
                                            <label class="uk-align-right uk-text-danger"><a class="uk-link-reset" href="password/reset">Forgot password?</a></label>
                                        </div> -->

                                        <div class="uk-margin-small uk-width-1-1">
                                            <button
                                                class="uk-button uk-width-1-1 uk-button-primary uk-border-rounded uk-float-left"
                                                type="submit" name="login_me">Login</button>
                                        </div>
                                    </form>
                                    <!-- login form end -->
