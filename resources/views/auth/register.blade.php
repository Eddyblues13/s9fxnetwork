                                ...
                                <div class="in-padding-horizontal@s">
                                    ...
                                    <a class="uk-logo" href="index.php">
                                        <img class="in-offset-top-10" src="{{asset('image/logo.png')}}"
                                            ...
                                            style="margin-top: 15px;" data-uk-img>
                                    </a>
                                    <!-- module logo begin -->
                                    ...
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                                            ...
                                            <input class="uk-input uk-border-rounded " name="name" id="name"
                                                :value="old('name')" type="text" placeholder="Enter your full name"
                                        ...
                                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                                            ...
                                            <input class="uk-input uk-border-rounded " name="username"
                                                :value="old('username')" id="username" type="text"
                                                placeholder="Username" required>
                                        </div>

                                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                                            <span class="uk-form-icon uk-form-icon-flip fas fa-phone fa-sm"></span>
                                            <input class="uk-input uk-border-rounded " name="phone" id="phone"
                                                :value="old('phone')" type="tel" placeholder="Phone Number" required
                                                autocomplete="phone">
                                        </div>

                                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                                            <span class="uk-form-icon uk-form-icon-flip fas fa-globe fa-sm"></span>
                                            <select class="uk-select uk-border-rounded " id="country" name="country"
                                                autocomplete="country" autofocus>
                                                <option disabled value="" selected>Select your country</option>
                                        ...
                                        <div class="uk-margin-small uk-width-auto uk-text-small">
                                            <label><input class="uk-checkbox uk-border-rounded" name="remember"
                                                    type="checkbox" required> Accept our <a
                                                    href="page/terms-of-services.php">terms and conditions</a></label>
                                        </div>
...
<!-- Mirrored from bluemainoptions.com/register by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Sep 2023 18:43:24 GMT -->
